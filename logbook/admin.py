...
class FlightLogAdmin(admin.ModelAdmin):
    ...
    search_fields = ("remarks", "aircraft__registration", "departure_airport__icao_code", "arrival_airport__icao_code")
    readonly_fields = ("total_time",)
    autocomplete_fields = ("aircraft", "departure_airport", "arrival_airport")
    fieldsets = (
        (None, {"fields": ("status", "planned_date", "planned_departure_time", "aircraft", "departure_airport", "arrival_airport")}),
